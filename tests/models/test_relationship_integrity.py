...
"""
This module contains unit tests for checking the
integrity of relationships between models.
"""
...
def test_review_relationship():
    """
    Test the relationship between a Review and
    its author User, as well as the relationship
    between a Review and its associated Place.
    """
    place = test4.add_place("Central Park Apartment", New_York,
                            "A lovely apartment near Central Park.", 100, 4)
    with pytest.raises(ValueError):
        review = test4.add_review(place=place,
                                  text="Great place to stay!", rating=5.0)
